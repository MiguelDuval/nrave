...
void DlgPrefLibrary::slotRemoveDir() {
    ...
    removeMsgBox.setText(tr(
            "NRave will no longer watch this directory for new tracks. "
            ...
            "<li>Delete all metadata for these tracks from NRave permanently.</li>"
    ...
    removeMsgBox.setInformativeText(tr(
            ...
            "NRave library. No files on disk will be changed or deleted."));
...
void DlgPrefLibrary::slotSeratoMetadataExportClicked(bool checked) {
    if (checked) {
        if (QMessageBox::warning(this,
                    ...
                    QStringLiteral(
                            "Exporting Serato Metadata from NRave is "
                            ...
                            "NRave could potentially crash Serato DJ, "
