...
Item {
    ...
    implicitHeight: root.show4decks ? (root.showXfader ? 405 : root.fourDeckChannelHeight + 8) : (root.showXfader ? 180 : (root.showEqKnobs ? 159 : 142))
    ...
    Item {
        ...
        Row {
            ...
            x: 140 - width / 2
            y: 14
            PflButton { group: root.groups[0] }
            PflButton { group: root.groups[1] }
        }
    ...
    Item {
        ...
        Row {
            anchors.horizontalCenter: parent.horizontalCenter
            spacing: 2
            MixerChannel4Deck { group: root.groups[2]; leftStyle: "default"; rightStyle: "warning"; showEqKillButtons: root.showEqKillButtons; showEqKnobs: root.showEqKnobs; showXfader: root.showXfader }
            MixerChannel4Deck { group: root.groups[0]; leftStyle: "default"; rightStyle: "warning"; showEqKillButtons: root.showEqKillButtons; showEqKnobs: root.showEqKnobs; showXfader: root.showXfader }
            MixerChannel4Deck { group: root.groups[1]; leftStyle: "warning"; rightStyle: "default"; showEqKillButtons: root.showEqKillButtons; showEqKnobs: root.showEqKnobs; showXfader: root.showXfader }
            MixerChannel4Deck { group: root.groups[3]; leftStyle: "warning"; rightStyle: "default"; showEqKillButtons: root.showEqKillButtons; showEqKnobs: root.showEqKnobs; showXfader: root.showXfader }
        }
        Crossfader {
            anchors.horizontalCenter: parent.horizontalCenter
            groups: root.groups
