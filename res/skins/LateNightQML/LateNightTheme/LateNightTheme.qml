...
QtObject {
    ...
    readonly property color backgroundColor: "#070B10"
    ...
    readonly property int syncButtonHorizontalPadding: 0
    readonly property color syncExplicitLeaderColor: "#10D9E8"
    readonly property color syncImplicitLeaderColor: "#FFC857"
    readonly property color syncInactiveBackgroundColor: "#0A0F16"
    readonly property color textColor: "#F4F8FC"
    readonly property color textColorMuted: "#7D8C9A"
    readonly property color trackPropertyHighlightColor: "#1A222D"
    readonly property color trackPropertySelectedTextColor: "#06080D"
    readonly property color trackPropertySelectionColor: "#F4F8FC"
    readonly property color toolbarActiveColor: "#10D9E8"
    readonly property color toolbarBackgroundColor: "#0A0F16"
