...
QtObject {
    ...
    readonly property color buttonNormalColor: "#8FA2B5"
    readonly property color buttonPressedColor: white
    readonly property color darkGray: "#06090E"
    ...
    readonly property color deckButtonInactiveColor: "#0F1720"
    readonly property color deckDimButtonInactiveColor: "#16212B"
    readonly property color deckEmbeddedButtonInactiveColor: "#101A24"
    readonly property color deckPanelBorderDark: "#05080D"
    readonly property color deckPanelBorderLeft: "#1A2733"
    readonly property color deckPanelBorderLight: "#263746"
    readonly property color deckPanelBorderRight: deckTopRowBackgroundColor
    readonly property color deckPanelColor: "#0B1118"
    readonly property color deckReadonlyTextColor: isClassic ? "#888888" : "#777777"
    readonly property color deckTimeTextColor: "#7FE7FF"
    readonly property color deckTopRowBackgroundColor: "#0F1720"
    ...
    readonly property color effectsControllerColor34: "#9D7BFF"
    ...
    readonly property color effectsUnitColor34: "#9D7BFF"
    ...
    readonly property color libraryPanelSplitterBackground: "#0A1018"
    readonly property color libraryPanelSplitterHandle: "#435568"
    readonly property color libraryPanelSplitterHandleActive: "#00D9FF"
    readonly property color mixerAccentCyan: "#00D9FF"
    readonly property color mixerAccentOrange: "#FFC857"
    readonly property color mixerAccentRed: "#FF3B63"
    readonly property color mixerArcEqColor: "#7B8EA1"
    readonly property color mixerArcGainColor: "#FFC857"
    readonly property color mixerArcGainLowColor: "#B86BFF"
    ...
    readonly property color mixerControlTextColor: "#D5E2EC"
    readonly property color mixerDimTextColor: "#65778A"
    ...
    readonly property color mixerPanelColor: "#0C1219"
    ...
    readonly property color mixerSliderBarColor: "#00B8D9"
    ...
    readonly property color toolbarButtonActiveBackgroundColor: "#153C49"
    readonly property color toolbarButtonActiveTextColor: "#EFFFFF"
    readonly property int toolbarButtonHeight: 26
    readonly property color toolbarButtonInactiveBackgroundColor: "#101923"
    readonly property color toolbarButtonInactiveTextColor: "#9DB0C0"
    ...
    readonly property color toolbarMenuHoverColor: "#173847"
    ...
    readonly property color waveformBeatAxesColor: "#89A0B4"
    readonly property color waveformCueColor: "#FFB13B"
    ...
    readonly property color waveformFilteredHighColor: "#6BE9FF"
    readonly property color waveformFilteredLowColor: "#4C72FF"
    readonly property color waveformFilteredMidColor: "#9D7BFF"
    readonly property color waveformIntroOutroColor: "#7A6CFF"
    ...
    readonly property color waveformPrimaryBackgroundColor: "#070C12"
    readonly property color waveformSecondaryBackgroundColor: "#0B1420"
    readonly property color white: "#F4FAFF"
